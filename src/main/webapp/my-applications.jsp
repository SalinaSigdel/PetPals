...
<div class="applications-container">
  ...
  <% } else { %>
  <% for (AdoptionApplication appItem : applications) {
    Pet pet = petService.getPetById(appItem.getPetId());
  ...
  <div class="application-card">
    <div class="application-header">
      <div class="application-id">Application #<%= appItem.getApplicationId() %></div>
      <div class="application-status status-<%= appItem.getStatus().toLowerCase() %>">
        <%= appItem.getStatus().substring(0, 1).toUpperCase() + appItem.getStatus().substring(1) %>
      </div>
    </div>
    <div class="application-body">
      ...
      <div class="application-details">
        ...
        <div class="application-date">
          <i class="far fa-calendar-alt"></i> Applied on: <%= new java.text.SimpleDateFormat("MMM d, yyyy").format(appItem.getCreatedAt()) %>
        </div>
        <div class="pet-info">
        ...
        <div class="application-actions">
          <a href="application-details?id=<%= appItem.getApplicationId() %>" class="btn-view-details">
